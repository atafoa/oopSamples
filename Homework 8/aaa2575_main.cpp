...
int main()
{
	...
	Customer customer{"Cole Wheeler", 006, 3615502335, "cole.wheeler@gmail.com", 5.0}
	customer.get_info();
	customer.get_balance();

	Bundle bundle{"Cole's Bundle", 007, "Book", "Historical Fiction Books", "Fiction"}
	book fiction1{"Ernst Hemingway",1926, "The Sun Also Rises", "Fiction",008, "Book"};
	book fiction2{"Ernst Hemingway",1952, "The Old Man and the Sea", "Fiction",009, "Book"};
	bundle.get_info();
	bundle.add_to_bundle(fiction1);
	bundle.add_to_bundle(fiction2);
	bundle.list_items();
	bundle.remove_from_bundle(009);
