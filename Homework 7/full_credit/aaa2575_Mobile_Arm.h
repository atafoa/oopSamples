...
class Mobile_Arm : public Super_Arm, public Mobile_Robot 
{
	...
	public:
    Mobile_Arm(int mn, string n, int bl, int l, int w, int el, int ml, string t) : Robot(mn, n, bl, t), Arm_Robot(mn, n, bl, l, w, t), Super_Arm(mn, n, bl, l, w, el, ml, t), Mobile_Robot(mn, n, bl, t) {};
